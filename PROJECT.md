...
| 16 | Интеграция Senti Translate (BETA) локального перевода в реальном времени | [x] | [page.tsx](file:///f:/c.echo/apps/web/src/app/room/[id]/page.tsx), [room.module.css](file:///f:/c.echo/apps/web/src/app/room/[id]/room.module.css) | Реализован модуль локального перевода в реальном времени с поддержкой Web Speech API, интерактивной боковой панелью, историей и плавающими glassmorphic субтитрами. |
