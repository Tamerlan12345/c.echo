...
for var in LIVEKIT_TCP_PORT RAILWAY_PROXY_TARGET_PORT LIVEKIT_API_KEY LIVEKIT_API_SECRET REDIS_ADDRESS EXTERNAL_TURN_USERNAME EXTERNAL_TURN_CREDENTIAL; do
    require_env "$var"
done
